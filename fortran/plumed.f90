...
module plumed_module
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_int_scalar(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_int(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      integer(kind=c_int)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_short_scalar(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_short(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      integer(kind=c_short)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_long_scalar(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_long(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      integer(kind=c_long)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_float_scalar(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_float(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      real(kind=c_float)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_double_scalar(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_double(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      real(kind=c_double)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_long_double_scalar(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_long_double(p,key,val,pass_shape,nocopy,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      real(kind=c_long_double)                           :: val(*)
