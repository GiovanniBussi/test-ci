...
module plumed_module
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_int(p,key,val,pass_shape,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      integer(kind=c_int)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_short(p,key,val,pass_shape,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      integer(kind=c_short)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_long(p,key,val,pass_shape,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      integer(kind=c_long)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_float(p,key,val,pass_shape,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      real(kind=c_float)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_double(p,key,val,pass_shape,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      real(kind=c_double)                           :: val(*)
  ...
  interface
    subroutine plumed_f_cmd_safe_nothrow_long_double(p,key,val,pass_shape,e,eh) bind(C)
      import
      character(kind=c_char), intent(in)    :: p(32)
      character(kind=c_char), intent(in)    :: key(*)
      real(kind=c_long_double)                           :: val(*)
  ...
  contains
     ...
     subroutine plumed_f_cmd_char(p,key,val,dummy,error,ierror)
       ...
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_char(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
     ...
     subroutine plumed_f_gcmd_char(key,val,dummy,error,ierror)
       character(kind=c_char,len=*),  intent(in)    :: key
       character(kind=c_char,len=*), asynchronous   :: val
       type(dummy_type),   optional                 :: dummy
       type(plumed_error), optional,  intent(out)   :: error
    ...
    subroutine plumed_f_cmd_integer_0_0(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      ...
      pass_shape=(/1,0/)
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_int_scalar(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_integer_0_1(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_int), asynchronous              :: val(:)
       type(dummy_type),   optional                 :: dummy
      ...
      pass_shape(2)=0
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_int(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_integer_0_2(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_int), asynchronous              :: val(:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_0_3(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_int), asynchronous              :: val(:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_0_4(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_int), asynchronous              :: val(:,:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_1_0(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      ...
      pass_shape=(/1,0/)
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_short_scalar(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_integer_1_1(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_short), asynchronous              :: val(:)
       type(dummy_type),   optional                 :: dummy
      ...
      pass_shape(2)=0
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_short(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_integer_1_2(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_short), asynchronous              :: val(:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_1_3(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_short), asynchronous              :: val(:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_1_4(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_short), asynchronous              :: val(:,:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_2_0(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      ...
      pass_shape=(/1,0/)
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_long_scalar(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_integer_2_1(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_long), asynchronous              :: val(:)
       type(dummy_type),   optional                 :: dummy
      ...
      pass_shape(2)=0
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_long(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_integer_2_2(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_long), asynchronous              :: val(:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_2_3(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_long), asynchronous              :: val(:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_integer_2_4(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      integer(KIND=c_long), asynchronous              :: val(:,:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_0_0(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      ...
      pass_shape=(/1,0/)
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_float_scalar(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_real_0_1(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_float), asynchronous              :: val(:)
       type(dummy_type),   optional                 :: dummy
      ...
      pass_shape(2)=0
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_float(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_real_0_2(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_float), asynchronous              :: val(:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_0_3(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_float), asynchronous              :: val(:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_0_4(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_float), asynchronous              :: val(:,:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_1_0(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      ...
      pass_shape=(/1,0/)
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_double_scalar(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_real_1_1(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_double), asynchronous              :: val(:)
       type(dummy_type),   optional                 :: dummy
      ...
      pass_shape(2)=0
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_double(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_real_1_2(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_double), asynchronous              :: val(:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_1_3(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_double), asynchronous              :: val(:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_1_4(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_double), asynchronous              :: val(:,:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_2_0(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      ...
      pass_shape=(/1,0/)
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_long_double_scalar(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_real_2_1(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_long_double), asynchronous              :: val(:)
       type(dummy_type),   optional                 :: dummy
      ...
      pass_shape(2)=0
       if(present(error) .or. present(ierror)) then
         call plumed_f_cmd_safe_nothrow_long_double(p,key,val,pass_shape,c_loc(myerror),c_funloc(error_handler))
         if(present(error)) then
           error=myerror
         endif
         if(present(ierror)) then
    ...
    subroutine plumed_f_cmd_real_2_2(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_long_double), asynchronous              :: val(:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_2_3(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_long_double), asynchronous              :: val(:,:,:)
       type(dummy_type),   optional                 :: dummy
    ...
    subroutine plumed_f_cmd_real_2_4(p,key,val,dummy,error,ierror)
      character(kind=c_char,len=32), intent(in)    :: p
      character(kind=c_char,len=*),  intent(in)    :: key
      real(KIND=c_long_double), asynchronous              :: val(:,:,:,:)
       type(dummy_type),   optional                 :: dummy
